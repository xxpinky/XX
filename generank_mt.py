# -*- coding: utf-8 -*-
"""
Created on Mon Dec 18 13:24:32 2017
...
def run_rank(expr, ppi):
    ...
    rank.to_csv("{}_rank.txt".format(name), header=False, index=False)
    end = time.time()
...
if __name__ == "__main__":
    ...
    ppi = read_ppi()
    dir_ = '/home/xxu/generank/CHIP-matrixN/'
